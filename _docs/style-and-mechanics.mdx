...
Prefer gender neutral names when referencing fictional individuals. Use names from diverse cultural backgrounds.

<UsageBlock>
<Usage type="yes">

### Yes
- Alex, Cameron, Charan, Jordan, Kai, Logan, Morgan, Quinn, Remy, Sacha

</Usage>
<Usage type="no">

### No
- Alice, Charles, Elizabeth, James, John, Margaret, Mary, Robert, Sarah, William
